...
public class Packet {
	 ...
	 * @throws PacketCRCException CRC is wrong
	 */
	public Packet(byte [] recvData) throws PacketCRCException 
	{
		checkCRC(recvData);
	...
	private void checkCRC(byte [] pkt) throws PacketCRCException
	{
		int pLen = pkt.length;
		...
		if( 
			...
			throw new  PacketCRCException(pkt);
	}
