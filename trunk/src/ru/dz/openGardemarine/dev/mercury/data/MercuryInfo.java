...
public class MercuryInfo extends MercuryRequest {
	...
	public MercuryInfo(Mercury230Connection c) throws IOException, ProtocolException 
	{
		byte[] packet;
	...
	private static byte[] getParameter(Mercury230Connection c, int nParam) throws IOException, ProtocolException
	{
